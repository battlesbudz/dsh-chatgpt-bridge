...
const client = new Client({ name: 'dsh-chatgpt-bridge-goal-dogfood', version: '0.3.0' });
...
try {
  ...
  check('version 0.3.0', health.parsed?.bridge?.version === '0.3.0', String(health.parsed?.bridge?.version));
